...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_retrieve_deliversFailureOnRetrievalError() {
        // to clear why testSpecificStoreURL() is tied for the test and what related to sut
    ...
    private func expect(_ sut: FeedStore, toRetrieveTwice expectedResult: RetriveCachedResult, file: StaticString = #file, line: UInt = #line) {
        expect(sut, toRetrieve: expectedResult, file: file, line: line)
        expect(sut, toRetrieve: expectedResult, file: file, line: line)
    }
    
    private func expect(_ sut: FeedStore, toRetrieve expectedResult: RetriveCachedResult, file: StaticString = #file, line: UInt = #line) {
